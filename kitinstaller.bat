...
SET REPO_DOWNLOAD_URL=https://github.com/kandikits/Breast-Cancer-Prediction/releases/download/v1.0/Breast-Cancer-Prediction-main.zip
SET REPO_DEPENDENCIES_URL=https://github.com/kandikits/Breast-Cancer-Prediction/raw/main/requirements.txt
SET REPO_NAME=breast-cancer-prediction.zip
SET EXTRACTED_REPO_DIR=breast-cancer-prediction-main
SET NOTEBOOK_NAME=Breast Cancer Prediction Using SVM.ipynb
where /q python
IF ERRORLEVEL 1 (
	ECHO==========================================================================
